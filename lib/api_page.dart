                  ...
                  return Column(
                    children: [
                      Card(
                        ...
                        child: Column(
                          children: [
                            ListTile(title: Text("Action", style: TextStyle(
                                fontSize: 20, color: Colors.red)),
                              trailing: Text("${snapshot.data!.active}",
                                  style: TextStyle(
                                      fontSize: 20, color: Colors.red)),
                            ),
                            ListTile(title: Text("cases", style: TextStyle(
                                fontSize: 20, color: Colors.red)),
                              trailing: Text("${snapshot.data!.cases}",
                                  style: TextStyle(
                                      fontSize: 20, color: Colors.red)),
                            ),
                            ListTile(title: Text("tests", style: TextStyle(
                                fontSize: 20, color: Colors.red)),
                              trailing: Text("${snapshot.data!.tests}",
                                  style: TextStyle(
                                      fontSize: 20, color: Colors.red)),
                            ),
                            ListTile(title: Text("deaths", style: TextStyle(
                                fontSize: 20, color: Colors.red)),
